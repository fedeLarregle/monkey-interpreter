...
func Eval(node ast.Node, env *object.Environment) object.Object {
	...
	case *ast.CallExpression:
		...
		args := evalExprresions(node.Arguments, env)
...
func evalBlockStament(block *ast.BlockStatement, env *object.Environment) object.Object {
	var result object.Object
...
func evalExprresions(exps []ast.Expression, env *object.Environment) []object.Object {
	var result []object.Object
...
func unwrapReturnValue(obj object.Object) object.Object {
	// unwrapping return value to only stop the evaluation of the last called function's body
